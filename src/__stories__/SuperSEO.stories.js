  ...
  return (
    <>
      ...
      <div>
        <h1>SEO Example</h1>
        <p>
          If you inspect this iframe's elements, you can see that the title and
          meta tags in the <code>{`<head/>`}</code> element have been set.
        </p>
        <p>
          Click the "Open canvas in new tab" button (upper right) to view this
          iframe in its own tab.
        </p>
      </div>
      <div>
        <h4>Code: </h4>

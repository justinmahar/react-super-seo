...
function SuperSEO(props) {
  ...
  meta.push.apply(
    meta,
    createTwitterMetadataObjects(props.twitter, title, description)
  );
  ...
  return React.createElement(
    ...
    React.createElement(
      react_helmet_1.Helmet,
      { htmlAttributes: htmlAttributes, meta: meta },
      titleElement
    ),
    typeof props.children !== "undefined" &&
      React.createElement(react_helmet_1.Helmet, null, props.children)
  );
}
  ...
  if (data.ogType) {
    switch (data.ogType) {
      case "article":
        meta.push.apply(
          meta,
          createOpenGraphTypeArticleMetadataObjects(data.ogTypeObject)
        );
        break;
      case "book":
        meta.push.apply(
          meta,
          createOpenGraphTypeBookMetadataObjects(data.ogTypeObject)
        );
        break;
      case "profile":
        meta.push.apply(
          meta,
          createOpenGraphTypeProfileMetadataObjects(data.ogTypeObject)
        );
        break;
      case "website":
  ...
  if (data.twitterSummaryCardWithLargeImage) {
    meta.push.apply(
      ...
      createTwitterSummaryCardWithLargeImageMetadataObjects(
        data.twitterSummaryCardWithLargeImage,
        fallbackTitle,
        fallbackDescription
      )
    );
